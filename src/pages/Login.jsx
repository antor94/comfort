        ...
        <div className="container">
            <div className="login_row py-[50px] bg-[#F0F2F3] rounded-b-[20px] ">
                ...
                <div className='w-[648px] h-[450px] my-[100px] ml-[500px] pt-[32px] text-center px-[32px] bg-white shadow-[0px_4px_30px_0px_rgba(31,_38,_135,_0.15)]  '>
                    ...
                    <div className='w-[587px] bg-[#F0F2F3] rounded-[8px] mt-[24px] mb-[16px] '><input className='w-[90%] py-[17px] pl-[20px] text-[16px] font-normal font-inter text-[#9A9CAA]   border-none outline-none ' type="text" placeholder='Email' /></div>
                    <div className='w-[587px] bg-[#F0F2F3] px-[20px] rounded-[8px] flex justify-between items-center'>
                        
                        <input className='w-[90%] py-[17px]  text-[16px] font-normal font-inter text-[#9A9CAA] border-none outline-none ' type="text" placeholder='Email' />
                    <FaRegEye />
                    </div>
                    <div>
                        <div className='mt-[16px] mb-[24px] flex justify-between items-center'>
                            ...
                            <input className='w-[20px] h-[20px] rounded-1' type="checkbox" />
                            <p className='text-[14px] font-normal font-dm text-[#636270]'>Remember me</p>
                            </div>
